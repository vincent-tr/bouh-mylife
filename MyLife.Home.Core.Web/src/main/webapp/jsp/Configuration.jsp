	...
	<div id="tabs-2">
		<fieldset>
			...
			<form method="post" action="?action=create"
				...
				<input type="file" name="content" accept="application/xml" /> <input
					type="image" src="<%=WebTools.image(pageContext, "create.png")%>"
					title="Création" />
			</form>
		</fieldset>
		...
		<fieldset>
			...
			<form method="post" action="?action=contentCreate"
				enctype="multipart/form-data">
				<input type="file" name="content" accept="application/xml" /> <input
					type="image" src="<%=WebTools.image(pageContext, "upload.png")%>"
					title="Télécharger" />
			</form>
		</fieldset>
		...
		<fieldset>
			...
			<form method="post" action="?action=downloadCreate">
				<input type="text" name="url" /> <input type="image"
