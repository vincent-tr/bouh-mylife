...
#define ERROR_CORE_NOTFOUND 			ERROR_MAKE(ERROR_FACTORY_CORE, 2)
#define ERROR_CORE_EXISTS 				ERROR_MAKE(ERROR_FACTORY_CORE, 3)
#define ERROR_CORE_IOERROR 				ERROR_MAKE(ERROR_FACTORY_CORE, 4)
#define ERROR_CORE_BADMOD 				ERROR_MAKE(ERROR_FACTORY_CORE, 5)
#define ERROR_CORE_UNRESOLVEDDEP 		ERROR_MAKE(ERROR_FACTORY_CORE, 6)
#define ERROR_CORE_EXISTINGDEP 			ERROR_MAKE(ERROR_FACTORY_CORE, 7)
#define ERROR_CORE_DISCONNECTED 		ERROR_MAKE(ERROR_FACTORY_CORE, 8)
